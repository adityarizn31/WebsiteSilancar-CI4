...
<section class="p-4" id="main-content">
  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-body">
          ...
          <?php foreach ($pendaftaran_kk_perubahan as $kkperubahan) : ?>
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url('/DetailAdmin/detail_pendaftarankkperubahan_admin/' . $kkperubahan['namapemohon']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                ...
                <button class="btn btn-success btn-sm">
                  <a href="https://api.whatsapp.com/send/?phone=<?= $kkperubahan['nomorpemohon'] ?>&text=Assalamu%27alaikum%2C+perkenalkan+nama+saya.....&type=phone_number&app_absent=0" class="bi bi-whatsapp text-white" data-placement="top" title="Kirim Whatsapp"> Kirim WA</a>
                </button>

                <form action="<?= base_url('DeleteAdmin/tandaiSelesaiKKPerubahan/' . $kkperubahan['id']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                  <?php if ($kkperubahan['status'] === 'Belum di Proses') : ?>
                  ...
                  <?php elseif ($kkperubahan['status'] === 'Gagal Verifikasi' || $kkperubahan['status'] === 'Selesai Verifikasi') : ?>
      ...
      <?= $pager->links('pendaftaran_kk_perubahan', 'kkperubahan_pagination'); ?>
    </div>
  </div>
