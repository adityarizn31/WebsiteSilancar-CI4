  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-header py-3">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class="m-0 font-weight-bold text-primary">Data Pendaftaran Kartu Identitas Anak</h4>
        <a href="<?= base_url('/DeleteAdmin/dataSelesaiKIA'); ?>" method="POST" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2"><i></i> Data Selesai Proses </a>
      </div>
            ...
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url('DeleteAdmin/tandaiSelesaiKIA/' . $kia['id']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                  <?php if ($kia['status'] === 'Belum di Proses') : ?>
                  ...
                  <?php elseif ($kia['status'] === 'Gagal Verifikasi' || $kia['status'] === 'Selesai Verifikasi') : ?>
