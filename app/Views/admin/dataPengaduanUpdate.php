  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-header py-3">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class="m-0 font-weight-bold text-primary">Data Pendaftaran Selesai Permohonan Pengaduan Update</h4>
        <a href="<?= base_url('ExportExcel/exportPengaduanUpdate'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2"><i class="bi bi-download text-white"></i> Export Excel </a>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title fw-semibold" id="modalHapusLabel">Hapus Keseluruhan Data Pengaduan Update</h5>
            ...
            <div class="modal-footer">
              ...
              <form action="<?= base_url('DeleteAdmin/DeletePermanentPengaduanUpdate/'); ?>" method="post">
                <?= csrf_field(); ?>
      ...
      <?php if (session()->getFlashdata('pesan')) : ?>
        ...
        if ($pesan == 'Pendaftaran Permohonan Pengaduan Update telah dihapus !!') {
          $class = 'alert-success';
        } else {
          $class = 'alert-danger';
        }
    ...
    <div class="card-body">
      ...
      <?php
      usort($pendaftaran_pengaduanupdate, function ($a, $b) {
      ...
      <table class="table table-fixed table-hover">
        ...
        <tbody>
          ...
          <?php foreach ($pendaftaran_pengaduanupdate as $pengaduanupdate) : ?>
            <tr>
              <th scope="row"><?= $i++; ?></th>
              <td><?= $pengaduanupdate['namapemohon']; ?></td>
              ...
              <td>
                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $pengaduanupdate['id']; ?>">
                  Hapus
                </button>

                <div class="modal fade" id="modalHapus<?= $pengaduanupdate['id']; ?>" tabindex="-1" aria-labelledby="modalHapusLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <form action="<?= base_url('DeleteAdmin/deletePermanentPengaduanUpdate/' . $pengaduanupdate['id']); ?>" method="post">
                          <?= csrf_field(); ?>
                          <button type="submit" class="btn btn-danger">Hapus</button>
                        </form>
                      </div>
