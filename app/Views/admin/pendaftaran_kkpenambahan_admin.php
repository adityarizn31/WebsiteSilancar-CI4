...
<section class="p-4" id="main-content">
  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-body">
            ...
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url('DeleteAdmin/tandaiSelesaiKKPenambahan/' . $kkpenambahan['id']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                  <?php if ($kkpenambahan['status'] === 'Belum di Proses') : ?>
                  ...
                  <?php elseif ($kkpenambahan['status'] === 'Gagal Verifikasi' || $kkpenambahan['status'] === 'Selesai Verifikasi') : ?>
      ...
      <?= $pager->links('pendaftaran_kk_penambahan', 'kkpenambahan_pagination'); ?>
    </div>
  </div>
