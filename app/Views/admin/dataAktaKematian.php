  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-header py-3">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        ...
        <a href="<?= base_url('ExportExcel/export_pendaftaranaktakematian'); ?>" method="POST" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2"><i class="fas fa-download fa-sm text-white-50"></i> Download Data </a>
      </div>
