  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-header py-3">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class="m-0 font-weight-bold text-primary">Data Pendaftaran Selesai Permohonan Akta Kematian</h4>
        <a href="<?= base_url('ExportExcel/exportAktaKematian'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2"><i class="bi bi-download text-white"></i> Export Excel </a>
      </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title fw-semibold" id="modalHapusLabel">Hapus Keseluruhan Data Akta Kematian</h5>
            ...
            <div class="modal-footer">
              ...
              <form action="<?= base_url('DeleteAdmin/DeletePermanentAktaKematian/'); ?>" method="post">
                <?= csrf_field(); ?>
    ...
    <div class="card-body">
      ...
      <?php
      usort($pendaftaran_aktakematian, function ($a, $b) {
        ...
        <tbody>
          ...
          <?php foreach ($pendaftaran_aktakematian as $aktakematian) : ?>
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $aktakematian['id']; ?>">
                  Hapus
                </button>

                <div class="modal fade" id="modalHapus<?= $aktakematian['id']; ?>" tabindex="-1" aria-labelledby="modalHapusLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <form action="<?= base_url('DeleteAdmin/deletePermanentAktaKematian/' . $aktakematian['id']); ?>" method="post">
                          <?= csrf_field(); ?>
                          <button type="submit" class="btn btn-danger">Hapus</button>
                        </form>
                      </div>
