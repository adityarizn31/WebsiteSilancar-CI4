  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-header py-3">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class="m-0 font-weight-bold text-primary">Data Pendaftaran KK Pemisahan Anggota Keluarga</h4>
        <a href="<?= base_url('/DeleteAdmin/dataSelesaiKKPemisahan'); ?>" method="POST" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2"><i></i> Data Selesai Proses </a>
      </div>
    ...
    <div class="card-body">
          ...
          <?php foreach ($pendaftaran_kk_pemisahan as $kkpemisahan) : ?>
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url('/DetailAdmin/detail_pendaftarankkpemisahan_admin/' . $kkpemisahan['namapemohon']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                ...
                <button class="btn btn-success btn-sm">
                  <a href="https://api.whatsapp.com/send/?phone=<?= $kkpemisahan['nomorpemohon'] ?>&text=Assalamu%27alaikum%2C+perkenalkan+nama+saya.....&type=phone_number&app_absent=0" class="bi bi-whatsapp text-white" data-placement="top" title="Kirim Whatsapp"> Kirim WA</a>
                </button>

                <form action="<?= base_url('DeleteAdmin/tandaiSelesaiKKPemisahan/' . $kkpemisahan['id']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                  <?php if ($kkpemisahan['status'] === 'Belum di Proses') : ?>
                  ...
                  <?php elseif ($kkpemisahan['status'] === 'Gagal Verifikasi' || $kkpemisahan['status'] === 'Selesai Verifikasi') : ?>
      ...
      <?= $pager->links('pendaftaran_kk_pemisahan', 'kkpemisahan_pagination'); ?>
    </div>
  </div>
