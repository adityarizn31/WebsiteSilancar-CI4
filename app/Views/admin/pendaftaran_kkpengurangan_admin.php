...
<section class="p-4" id="main-content">
  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-body">
          ...
          <?php foreach ($pendaftaran_kk_pengurangan as $kkpengurangan) : ?>
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url('/DetailAdmin/detail_pendaftarankkpengurangan_admin/' . $kkpengurangan['namapemohon']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                ...
                <button class="btn btn-success btn-sm">
                  <a href="https://api.whatsapp.com/send/?phone=<?= $kkpengurangan['nomorpemohon'] ?>&text=Assalamu%27alaikum%2C+perkenalkan+nama+saya.....&type=phone_number&app_absent=0" class="bi bi-whatsapp text-white" data-placement="top" title="Kirim Whatsapp"> Kirim WA</a>
                </button>

                <form action="<?= base_url('DeleteAdmin/tandaiSelesaiKKPengurangan/' . $kkpengurangan['id']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                  <?php if ($kkpengurangan['status'] === 'Belum di Proses') : ?>
                  ...
                  <?php elseif ($kkpengurangan['status'] === 'Gagal Verifikasi' || $kkpengurangan['status'] === 'Selesai Verifikasi') : ?>
      ...
      <?= $pager->links('pendaftaran_kk_pengurangan', 'kkpengurangan_pagination'); ?>
    </div>
  </div>
