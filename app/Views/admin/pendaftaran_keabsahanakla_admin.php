  ...
  <div class="card shadow mb-4" style="margin-top: 25px;">
    ...
    <div class="card-header py-3">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-2">
        ...
        <a href="<?= base_url('/DeleteAdmin/dataSelesaiKeabsahanAkla'); ?>" method="POST" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2"><i></i> Data Selesai Proses </a>
      </div>
          ...
          <?php foreach ($pendaftaran_keabsahanakla as $keabsahan) : ?>
            <tr>
              ...
              <td>
                ...
                <form action="<?= base_url('/DetailAdmin/detail_pendaftarankeabsahanaklaa_admin/' . $keabsahan['namapemohon']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                ...
                <button class="btn btn-success btn-sm">
                  <a href="https://api.whatsapp.com/send/?phone=<?= $keabsahan['nomorpemohon'] ?>&text=Assalamu%27alaikum%2C+perkenalkan+nama+saya.....&type=phone_number&app_absent=0" class="bi bi-whatsapp text-white" data-placement="top" title="Kirim Whatsapp"> Kirim WA</a>
                </button>

                <form action="<?= base_url('DeleteAdmin/tandaiSelesaiKeabsahanAkla/' . $keabsahan['id']); ?>" method="post" class="d-inline">
                  <?= csrf_field(); ?>
                  <?php if ($keabsahan['status'] === 'Belum di Proses') : ?>
                  ...
                  <?php elseif ($keabsahan['status'] === 'Gagal Verifikasi' || $keabsahan['status'] === 'Selesai Verifikasi') : ?>
