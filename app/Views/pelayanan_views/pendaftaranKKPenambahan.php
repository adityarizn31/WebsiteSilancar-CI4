...
?>
  ...
  <div class="container" style="padding: 10px;">
    <div class="card shadow mb-4" style="padding: 20px;">
      <div class="container">
        <h4 class="text-center mt-2 mb-2 fw-bold"> Pendaftaran Kartu Keluarga Penambahan Anggota Keluarga </h4>
      </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold"> Pendaftaran Kartu Keluarga Penambahan Anggota Keluarga </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <p>Selamat Pendaftaran Permohonan Kartu Keluarga Penambahan Anggota Keluarga Anda Telah Berhasil !!</p>
      ...
      <form action="/PelayananSilancar/saveKKPenambahan" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Kartu Keluarga Penambahan</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Kartu Keluarga Penambahan Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var suratnikah = document.getElementById('suratnikah').value;
            var suratketeranganlahir = document.getElementById('suratketeranganlahir').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || kartukeluargalama === '' || suratnikah === '' || suratketeranganlahir === '') {
