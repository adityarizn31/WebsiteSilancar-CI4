...
?>
  ...
  <div class="container" style="padding: 10px;">
    <div class="card shadow mb-4" style="padding: 20px;">
      <div class="container">
        <h4 class="text-center mt-2 mb-2 fw-bold"> Pendaftaran Kartu Keluarga Pengurangan Anggota Keluarga </h4>
      </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold"> Pendaftaran Kartu Keluarga Pengurangan Anggota Keluarga </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <p>Selamat Pendaftaran Permohonan Kartu Keluarga Pengurangan Anggota Keluarga Anda Telah Berhasil !!</p>
      ...
      <form action="/PelayananSilancar/saveKKPengurangan" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="mb-3">
            <label for="filepengurangan" class="form-label fw-semibold"> Berkas Surat Pindah/ Surat Kematian/ Akta Cerai </label>
            <input type="file" name="filepengurangan" id="filepengurangan" class="form-control text-black <?= (session('errors.filepengurangan')) ? 'is-invalid' : ''; ?>" value="<?= old('filepengurangan'); ?>">
            <div class="invalid-feedback">
              <?= session('errors.filepengurangan') ?>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Kartu Keluarga Pengurangan</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Kartu Keluarga Pengurangan Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var filepengurangan = document.getElementById('filepengurangan').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || kartukeluargalama === '' || filepengurangan === '') {
