...
?>
  ...
  <div class="container" style="padding: 10px;">
    <div class="card shadow mb-4" style="padding: 20px;">
      <div class="container">
        <h4 class="text-center mt-2 mb-2 fw-bold"> Pendaftaran Kartu Keluarga Baru </h4>
      </div>
      ...
      <form action="/PelayananSilancar/saveKK" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Kartu Keluarga</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Kartu Keluarga Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var formulirdesa = document.getElementById('formulirdesa').value;
            var kartukeluargasuami = document.getElementById('kartukeluargasuami').value;
            var kartukeluargaistri = document.getElementById('kartukeluargaistri').value;
            var suratnikah = document.getElementById('suratnikah').value;
            var suratpindah = document.getElementById('suratpindah').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || formulirdesa === '' || kartukeluargasuami === '' || kartukeluargaistri === '' || suratnikah === '' || suratpindah === '') {
