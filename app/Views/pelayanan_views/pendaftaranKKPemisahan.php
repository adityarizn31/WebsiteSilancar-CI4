...
?>
  ...
  <div class="container" style="padding: 10px;">
    <div class="card shadow mb-4" style="padding: 20px;">
      <div class="container">
        <h4 class="text-center mt-2 mb-2 fw-bold"> Pendaftaran Kartu Keluarga Pemisahan Anggota Keluarga </h4>
      </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold"> Pendaftaran Kartu Keluarga Pemisahan </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <p>Selamat Pendaftaran Permohonan Kartu Keluarga Pemisahan Anda Telah Berhasil !!</p>
      ...
      <form action="/PelayananSilancar/saveKKPemisahan" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="mb-3">
            <label for="filepemisahan" class="form-label fw-semibold"> Berkas Surat Pindah / Surat Kematian / Akta Cerai </label>
            <input type="file" name="filepemisahan" id="filepemisahan" class="form-control text-black <?= (session('errors.filepemisahan')) ? 'is-invalid' : ''; ?>" value="<?= old('filepemisahan'); ?>">
            <div class="invalid-feedback">
              <?= session('errors.filepemisahan') ?>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Kartu Keluarga Pemisahan</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Kartu Keluarga Pemisahan Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var filepemisahan = document.getElementById('filepemisahan').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || kartukeluargalama === '' || filepemisahan === '') {
