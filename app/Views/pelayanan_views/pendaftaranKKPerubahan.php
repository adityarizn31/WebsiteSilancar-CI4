...
?>
  ...
  <div class="container" style="padding: 10px;">
    <div class="card shadow mb-4" style="padding: 20px;">
      <div class="container">
        <h4 class="text-center mt-2 mb-2 fw-bold"> Pendaftaran Kartu Keluarga Perubahan Elemen Data Anggota</h4>
      </div>
      ...
      <form action="/PelayananSilancar/saveKKPerubahan" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Kartu Keluarga Perubahan</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Kartu Keluarga Perubahan Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var fileperubahan = document.getElementById('fileperubahan').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || kartukeluargalama === '' || suratnikah === '' || fileperubahan === '') {
