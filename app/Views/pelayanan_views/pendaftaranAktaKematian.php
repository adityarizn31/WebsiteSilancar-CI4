          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Selamat Pendaftaran Permohonan Akta Kematian Anda Telah Berhasil !!</p>
      ...
      <form action="/PelayananSilancar/saveAktaKematian" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Akta Kematian</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Akta Kematian Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var suratkematian = document.getElementById('suratkematian').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || kartukeluarga === '' || suratkematian === '') {
