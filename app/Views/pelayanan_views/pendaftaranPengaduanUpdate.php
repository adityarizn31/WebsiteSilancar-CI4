      ...
      <form action="/PelayananSilancar/savePengaduanUpdate" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modalPendaftaran" tabindex="-1" aria-labelledby="modalPendaftaranLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-semibold" id="modalPendaftaranLabel">Data Pendaftaran Pengaduan Update</h5>
              ...
              <div class="modal-footer">
                <p>Mohon cek kembali data Pendaftaran Pengaduan Update Anda. <b>Apakah Anda sudah yakin dengan data di atas ??</b></p>
        ...
        <script>
          function validasiData() {
            ...
            var pengaduanupdate = document.getElementById('pengaduanupdate').value;

            if (nik === '' || namaPemohon === '' || emailPemohon === '' || nomorPemohon === '' || alamatPemohon === '' || fotoktp === '' || kartutandapenduduk === '' || kartukeluarga === '' || pengaduanupdate === '') {
          ...
          function tampilkanDataPendaftaran() {
            ...
            var html = '<p><b>NIK Pemohon:</b> ' + nik + '</p>' +
              ...
              '<p><b>Pengaduan Update:</b> ' + pengaduanupdate + '</p>';
