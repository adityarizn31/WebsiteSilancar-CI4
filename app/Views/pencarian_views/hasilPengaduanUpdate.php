...
<div class="container text-black">
  <div class="row">
    ...
    <h3 class="text-center fw-semibold">Cek Hasil Pengaduan Update</h3>

    <table class="table text-center table-fixed table-responsive-sm" style="margin-top: 5%;">

      <?php foreach ($pengaduan_update as $pengdat) : ?>
        ...
        <tbody class="">
          ...
          <tr>
            <th>Nama Pemohon :</th>
            <td><?= $pengdat['namapemohon'] ?></td>
          </tr>

          <tr>
            <th>Email Pemohon :</th>
            <td><?= $pengdat['emailpemohon'] ?></td>
          </tr>

          <tr>
            <th>Nomor Pemohon :</th>
            <td><?= $pengdat['nomorpemohon'] ?></td>
          </tr>

          <tr>
            <th>Alamat Pemohon :</th>
            <td><?= $pengdat['alamatpemohon'] ?></td>
          </tr>
