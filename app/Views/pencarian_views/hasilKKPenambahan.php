...
<div class="container text-black">
  <div class="row">
    ...
    <h3 class="text-center fw-semibold">Cek Hasil KK Penambahan Anggota</h3>
      ...
      <?php foreach ($pendaftaran_kk_penambahan as $kkpenambahan) : ?>
        ...
        <tbody class="">
          ...
          <tr>
            ...
            <td><?= $kkpenambahan['alamatpemohon'] ?></td>
          </tr>
