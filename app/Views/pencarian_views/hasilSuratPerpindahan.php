...
<div class="container text-black">
  <div class="row">
    ...
    <h3 class="text-center fw-semibold">Cek Hasil Surat Perpindahan Domisili Majalengka menuju Luar Kabupaten</h3>
      ...
      <?php foreach ($pendaftaran_suratperpindahan as $suratperpindahan) : ?>
        ...
        <tbody class="">
          ...
          <tr>
            ...
            <td><?= $suratperpindahan['alamatpemohon'] ?></td>
          </tr>
          ...
          <tr>
            ...
            <td><?= $suratperpindahan['updated_at'] ?></td>
          </tr>
