...
<div class="container mb-3">
  <div class="row">
    <div class="col">
      ...
      <form action="/Searching/cariSuratPerpindahanLuar" method="post">
        ...
        <div class="row g-2">
          ...
          <div class="col-md">
            <div class="form-floating">
              <input type="text" name="keyword" class="form-control text-black" id="floatingInputGrid" placeholder="" autofocus>
          ...
          <div class="form-floating mb-3">
            ...
            <label for="floatingInputDisabled" class="fw-semibold text-black">Pendaftaran Surat Perpindahan Luar Menuju Majalengka</label>
          </div>
