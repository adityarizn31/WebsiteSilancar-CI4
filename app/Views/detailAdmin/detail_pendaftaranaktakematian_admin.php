      ...
      <div class="card card-outline card-primary">
        ...
        <div class="card-header py-3">
          ...
          <div class="d-grip gap-2 d-md-flex justify-content-md-end">
            ...
            <?php if ($pendaftaran_aktakematian['status'] === 'Belum di Proses') : ?>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p>Mohon untuk memverifikasi status Pendaftaran atas nama <b><?= $pendaftaran_aktakematian['namapemohon']; ?></b> terlebih dahulu </p>
          ...
          <div class="modal fade" id="modalVerifikasiPendaftaran" tabindex="-1" aria-labelledby="modalVerifikasiPendaftaranLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Pendaftaran atas nama <b><?= $pendaftaran_aktakematian['namapemohon']; ?></b> Apakah sudah Selesai ?? </p>
                </div>
                ...
                <div class="modal-footer">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-end">
                    ...
                    <form action="<?= base_url('DeleteAdmin/tandaiSelesaiAktaKematian/' . $pendaftaran_aktakematian['id']); ?>" method="post" class="d-inline">
                      <?= csrf_field(); ?>
        ...
        <div class="card-body">
          <table>
            ...
            <tr>
              ...
              <th width="20px">:</th>
              <td><?= $pendaftaran_aktakematian['nik']; ?></td>
            </tr>
          ...
          <div class="grid-container align-items-center justify-content-center">
            ...
            <form action="<?= base_url('/DetailAdmin/selesaiAktaKematian/' . $pendaftaran_aktakematian['namapemohon']) ?>" method="post">
              <?= csrf_field(); ?>
            ...
            <form action="<?= base_url('/DetailAdmin/belumSelesaiAktaKematian/' . $pendaftaran_aktakematian['namapemohon']) ?>" method="post">
              <?= csrf_field(); ?>
        ...
        <div class="col-sm-12 col-md-12" style="padding: 20px;">
          <div class="card card-outline card-primary">
            <div class="card-header">
              ...
              <?php if (file_exists(FCPATH . '/pelayanan/aktakematian/' . $pendaftaran_aktakematian['fotoktp'])) : ?>

                <form action="" method="post">
                  <a href="<?= base_url('/pelayanan/aktakematian/' . $pendaftaran_aktakematian['fotoktp']) ?>" download class="btn btn-success mx-2 mt-2 mb-2 mr-2 position-absolute top-0 end-0">
                    <i class="bi bi-download"></i>
                  </a>
                </form>

                <div class="col-sm-12">
                  <iframe class="mt-4" src="<?= base_url('/pelayanan/aktakematian/' . $pendaftaran_aktakematian['fotoktp']) ?>" frameborder="0" height="500" width="100%"></iframe>
                </div>
              <?php else : ?>
