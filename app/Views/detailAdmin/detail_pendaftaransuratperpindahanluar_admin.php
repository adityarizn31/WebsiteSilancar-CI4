      ...
      <div class="card card-outline card-primary">
        ...
        <div class="card-header py-3">
          ...
          <div class="d-grip gap-2 d-md-flex justify-content-md-end">
            ...
            <?php if ($pendaftaran_suratperpindahanluar['status'] === 'Belum di Proses') : ?>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p>Mohon untuk memverifikasi status Pendaftaran atas nama <b><?= $pendaftaran_suratperpindahanluar['namapemohon']; ?></b> terlebih dahulu </p>
          ...
          <div class="modal fade" id="modalVerifikasiPendaftaran" tabindex="-1" aria-labelledby="modalVerifikasiPendaftaranLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Pendaftaran atas nama <b><?= $pendaftaran_suratperpindahanluar['namapemohon']; ?></b> Apakah sudah Selesai ?? </p>
                </div>
                ...
                <div class="modal-footer">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-end">
                    ...
                    <form action="<?= base_url('DeleteAdmin/tandaiSelesaiSuratPerpindahanLuar/' . $pendaftaran_suratperpindahanluar['id']); ?>" method="post" class="d-inline">
                      <?= csrf_field(); ?>
        ...
        <div class="card-body">
          <table>
            ...
            <tr>
              <th width="">Email</th>
              <th width="">:</th>
              <td><?= $pendaftaran_suratperpindahanluar['emailpemohon']; ?></td>
            </tr>

            <tr>
              <th width="">Nomor Pemohon</th>
              <th width="">:</th>
              <td><?= $pendaftaran_suratperpindahanluar['nomorpemohon']; ?></td>
            </tr>

            <tr>
              <th width="">Alamat Pemohon</th>
              <th width="">:</th>
              <td><?= $pendaftaran_suratperpindahanluar['alamatpemohon']; ?></td>
            </tr>
          ...
          <div class="grid-container align-items-center justify-content-center">
            ...
            <form action="<?= base_url('/DetailAdmin/selesaiSuratPerpindahanLuar/' . $pendaftaran_suratperpindahanluar['namapemohon']) ?>" method="post">
              <?= csrf_field(); ?>
            ...
            <form action="<?= base_url('/DetailAdmin/belumSelesaiSuratPerpindahanLuar/' . $pendaftaran_suratperpindahanluar['namapemohon']) ?>" method="post">
              <?= csrf_field(); ?>
        ...
        <div class="col-sm-12 col-md-12" style="padding: 20px;">
          <div class="card card-outline card-primary">
            <div class="card-header">
              ...
              <?php if (file_exists(FCPATH . '/pelayanan/perpindahan_luar/' . $pendaftaran_suratperpindahanluar['fotoktp'])) : ?>

                <form action="" method="post">
                  <a href="<?= base_url('/pelayanan/perpindahan_luar/' . $pendaftaran_suratperpindahanluar['fotoktp']) ?>" download class="btn btn-success mx-2 mt-2 mb-2 mr-2 position-absolute top-0 end-0">
                    <i class="bi bi-download"></i>
                  </a>
                </form>

                <div class="col-sm-12">
                  <iframe class="mt-4" src="<?= base_url('/pelayanan/perpindahan_luar/' . $pendaftaran_suratperpindahanluar['fotoktp']) ?>" frameborder="0" height="500" width="100%"></iframe>
                </div>
              <?php else : ?>
        ...
        <div class="col-sm-12 col-md-12" style="padding: 20px;">
          <div class="card card-outline card-primary">
            ...
            <div class="card-header">
              <div class="card-title fw-semibold"> Berkas SKPWNI </div>
