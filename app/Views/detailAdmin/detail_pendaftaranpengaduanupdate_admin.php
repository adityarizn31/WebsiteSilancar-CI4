        ...
        <div class="card-body">
          <table>
            ...
            <tr>
              ...
              <td>
                <?php
                switch ($pengaduan_update['status']) {
          ...
          <div class="grid-container align-items-center justify-content-center">
            ...
            <form action="<?= base_url('/DetailAdmin/selesaiPengaduanUpdate/' . $pengaduan_update['namapemohon']) ?>" method="post">
              <?= csrf_field(); ?>
            ...
            <form action="<?= base_url('/DetailAdmin/belumSelesaiPengaduanUpdate/' . $pengaduan_update['namapemohon']) ?>" method="post">
              <?= csrf_field(); ?>
        ...
        <div class="col-sm-12 col-md-12" style="padding: 20px;">
          <div class="card card-outline card-primary">
            <div class="card-header">
              ...
              <?php if (file_exists(FCPATH . '/pelayanan/pengaduan_update/' . $pengaduan_update['fotoktp'])) : ?>

                <form action="" method="post">
                  <a href="<?= base_url('/pelayanan/pengaduan_update/' . $pengaduan_update['fotoktp']) ?>" download class="btn btn-success mx-2 mt-2 mb-2 mr-2 position-absolute top-0 end-0">
                    <i class="bi bi-download"></i>
                  </a>
                </form>

                <div class="col-sm-12">
                  <iframe class="mt-4" src="<?= base_url('/pelayanan/pengaduan_update/' . $pengaduan_update['fotoktp']) ?>" frameborder="0" height="500" width="100%"></iframe>
                </div>
              <?php else : ?>
