    ...
    <div class="col-sm-12 col-md-12" style="padding: 10px;">
      ...
      <div class="card-body">
        ...
        <div class="grid-container align-items-center justify-content-center">
          ...
          <form action="<?= base_url('/DetailAdmin/selesaiKIA/' . $pendaftaran_kia['namapemohon']) ?>" method="post">
            <?= csrf_field(); ?>
          ...
          <form action="<?= base_url('/DetailAdmin/belumSelesaiKIA/' . $pendaftaran_kia['namapemohon']) ?>" method="post">
            <?= csrf_field(); ?>
      ...
      <div class="col-sm-12 col-md-12" style="padding: 20px;">
        <div class="card card-outline card-primary">
          <div class="card-header">
            ...
            <?php if (file_exists(FCPATH . '/pelayanan/kia/' . $pendaftaran_kia['fotoktp'])) : ?>

              <form action="" method="post">
                <a href="<?= base_url('/pelayanan/kia/' . $pendaftaran_kia['fotoktp']) ?>" download class="btn btn-success mx-2 mt-2 mb-2 mr-2 position-absolute top-0 end-0">
                  <i class="bi bi-download"></i>
                </a>
              </form>

              <div class="col-sm-12">
                <iframe class="mt-4" src="<?= base_url('/pelayanan/kia/' . $pendaftaran_kia['fotoktp']) ?>" frameborder="0" height="500" width="100%"></iframe>
              </div>
            <?php else : ?>
