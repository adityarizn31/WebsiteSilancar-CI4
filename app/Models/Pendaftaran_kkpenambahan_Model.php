...
class Pendaftaran_kkpenambahan_Model extends Model
{
  ...
  protected $allowedFields = ['nik', 'namapemohon', 'emailpemohon', 'nomorpemohon', 'alamatpemohon', 'fotoktp', 'kartukeluargalama', 'suratnikah', 'suratketeranganlahir', 'status'];
  ...
  {
    return $this->table('pendaftaran_kk_penambahan')->like('nik', $keyword)->orLike('namapemohon', $keyword);
  }
